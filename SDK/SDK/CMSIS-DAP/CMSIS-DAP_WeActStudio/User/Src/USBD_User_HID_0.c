...
volatile uint8_t  USB_ResponseIdle;      // Response Idle  Flag
...
static uint8_t  Wl_USB_Request [DAP_PACKET_SIZE];  // Request  Buffer
static uint8_t  Wl_USB_Response [DAP_PACKET_SIZE];
...
//					else
//					{
//						if(osMessageQueueGet(Wireless_DAPResponseQueue,buf,NULL,0) != osErrorResource)
//						  return ((int32_t)DAP_PACKET_SIZE);
//						else
//							USB_ResponseIdle = 1U;
//					}
...
//			else
//			{
//				memcpy(Wl_USB_Request, buf, (uint32_t)len);
//				if(Wl_USB_Request[0] == ID_DAP_QueueCommands) Wl_USB_Request[0] = ID_DAP_ExecuteCommands;
//				if(osMessageQueuePut(Wireless_DAPRequestQueue,Wl_USB_Request,NULL,0) != osErrorResource) // ∂”¡–¬˙¡À
//					return true;
//				else return false;
//			}
      break;
      ...
      while (USB_Request[n][0] == ID_DAP_QueueCommands) {
        ...
        if (n == USB_RequestIndexI) {
          ...
          if (flags & 0x80U) {
			...
			{
				//Wireless_DAP_ExecuteCommand(USB_Request[USB_RequestIndexO],USB_Response[USB_ResponseIndexI]);
//				osMessageQueueGet(Wireless_DAPRequestQueue,Wl_USB_Request,NULL,osWaitForever);
//				Wireless_DAP_ExecuteCommand(Wl_USB_Request,Wl_USB_Response);
//				osMessageQueuePut(Wireless_DAPResponseQueue,Wl_USB_Response,NULL,osWaitForever);
//				if(USB_ResponseIdle)
//				{
//					if(osMessageQueueGet(Wireless_DAPResponseQueue,Wl_USB_Response,NULL,0)!= osErrorResource)
//					{
//					USB_ResponseIdle = 0;
//					
//					USBD_HID_GetReportTrigger(0U, 0U, Wl_USB_Response, DAP_PACKET_SIZE);
//					}
//				}
			}
